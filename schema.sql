...
ALTER TABLE tests ADD COLUMN IF NOT EXISTS marks_correct NUMERIC NOT NULL DEFAULT 0;
ALTER TABLE tests ADD COLUMN IF NOT EXISTS marks_negative NUMERIC NOT NULL DEFAULT 0;
